...
// Filtro de búsqueda
function filtrarServT() {
  const filtro = document.getElementById('inputBusquedaServT').value.toLowerCase();
  const filas = document.querySelectorAll('#servicesTable tbody tr');
